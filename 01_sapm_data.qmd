...
Le jeu de données n'inclut pas de métadonnées explicitant sa date, mais il nous a été expliTout indique qu'il s'agit d'un jeu datant de 2002 (cohérent avec les indications qui m'ont été données quand le jeu m'a été remis).
