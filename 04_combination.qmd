...
# Consolidation et appariement des sources
...
mnp_anka_rni_pre2002 <- read_rds("data/no_id/mnp_anka_rni_pre2002.rds")
mnp_mantadia_pre2002 <- read_rds("data/no_id/mnp_mantadia_pre2002.rds")
...
mnp_anka_rni_pre2002 <- mnp_anka_rni_pre2002 |
  rename(NAME = NOM) |
  mutate(dataset_id = "MNP_Anka_RNI_pre2002") |
  select(NAME, dataset_id, geometry)

mnp_mantadia_pre2002 <- mnp_mantadia_pre2002 |
  rename(NAME = NOM) |
  mutate(dataset_id = "MNP_Mantadia_pre2002") |
  select(NAME, dataset_id, geometry)
...
all_PAs <- bind_rows(
  angap_2002,
  mnp_2010,
  mnp_anka_rni_pre2002,
  mnp_mantadia_pre2002,
  sapm_2010,
  sapm_2017,
  sapm_2024,
  sapm_evol_2001_2011,
