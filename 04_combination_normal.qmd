...
On ajoute les aires protégées mentionnées dans les décrets à travers le jeu decision_pa. Ces données ne comportent pas de géométrie, aussi on en ajoute une vide afin de pouvoir les consolider dans la même table.

```{r}
# Format to be compatible with the spatial data
legal_conso <- decision_pa %>%
  mutate(
    NAME = ap_nom_texte,
