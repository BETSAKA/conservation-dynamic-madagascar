...
Après inspection visuelle, on retient MNP_2010 comme source du périmètre avant la modification de 2011.
...
sat <- sat |>
  add_modif_sat(
    ...
    notes = "Périmètre 1997-2011 avant modification des limites (géométrie MNP_2010 retenue après vérification visuelle). Périmètres pré-1997 non disponibles."
  )
```
