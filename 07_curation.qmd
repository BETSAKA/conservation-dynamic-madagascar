...
# Save Curated Tables {#sec-save-curated}
...
```{r}
#| label: save-curated-tables

# Save the Site Attribute Table
write_rds(sat, "data/sat_curated.rds")

# Save the Feature Attribute Table
write_rds(fat, "data/fat_curated.rds")
