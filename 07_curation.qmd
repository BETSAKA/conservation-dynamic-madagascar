...
La modification survenue en 1998 ne porte pas sur un changement de frontière. Elle porte sur un changement de statut juridique, de RNI à PN. 
...
Le changement de statut implique une modification de la désignation et de la catégorie IUCN. On documente ces changements d'attributs dans FAT.
...
fat <- NULL %>%
  add_modif_fat(
    ...
    notes = "RNI transformed to PN in 1998. No boundary change."
  )
```
